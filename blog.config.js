...
const BLOG = {
  ...
  SINCE: null, // e.g if leave this empty, current year will be used.
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '庐山烟雨浙江潮，未至千般恨不消, 欢迎来到我的空间🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '天宇', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的码农🐒', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://zone.moonyty.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '天宇, 博客', // 网站关键词 英文逗号隔开
  ...
  PRISM_THEME_LIGHT_PATH: 'https://cdn.jsdelivr.net/npm/prismjs@1.29.0/themes/prism-twilight.css', // 浅色模式主题
  ...
  //   ********挂件组件相关********
  // Chatbase
  CHATBASE_ID: process.env.NEXT_PUBLIC_CHATBASE_ID || '-WLIHp8o_Jzs29kqtfCcT', // 是否显示chatbase机器人 https://www.chatbase.co/
  // 悬浮挂件
  ...
  MUSIC_PLAYER_METING_ID:
      process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_ID || '8606199067', // 对应歌单的 id
  ...
  // twikoo
  COMMENT_TWIKOO_ENV_ID: 'https://twikoo.moonyty.com', // TWIKOO后端地址 腾讯云环境填envId；Vercel环境填域名，教程：https://tangly1024.com/article/notionnext-twikoo
  COMMENT_TWIKOO_COUNT_ENABLE: process.env.NEXT_PUBLIC_COMMENT_TWIKOO_COUNT_ENABLE || false, // 博客列表是否显示评论数
  COMMENT_TWIKOO_CDN_URL: 'https://cdn.staticfile.org/twikoo/1.6.16/twikoo.all.min.js', // twikoo客户端cdn
